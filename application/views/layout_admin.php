                            ...
                            <div class="dropdown-list-content dropdown-list-message">
                                <a href="#" class="dropdown-item dropdown-item-unread">
                                    <div class="dropdown-item-avatar">
                                        <img alt="<?php echo base_url('assets/admin/assets/img/avatar/avatar-1.png'); ?>"
                                ...
                                <a href="#" class="dropdown-item dropdown-item-unread">
                                    <div class="dropdown-item-avatar">
                                        <img alt="<?php echo base_url('assets/admin/assets/img/avatar/avatar-2.png'); ?>"
                                            class="rounded-circle">
                                    </div>
                                    <div class="dropdown-item-desc">
                                        <b>Dedik Sugiharto</b>
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li> <a class="nav-link" href="<?php echo site_url('Adminpanel/dashboard') ?>"><i
                                    class="fas fa-fire"></i><span>Dashboard</span></a>
                        <li> <a class="nav-link" href="<?php echo site_url('Kategori') ?>"><i
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i
                                    class="fas fa-plane"></i> <span>Jasa Pengiriman</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?php echo site_url('Kota') ?>"><i
                                            class="fas fa-city"></i>Kota</a></li>
                                <li><a class="nav-link" href="<?php echo site_url('Kurir') ?>"><i
                                            class="fas fa-truck"></i>Kurir</a></li>
                                <li><a class="nav-link" href="<?php echo site_url('Ongkoskirim') ?>"><i
                                            class="fas fa-address-card"></i>Ongkos Kirim</a></li>
                            </ul>
                        </li>
                        <li><a class="nav-link" href=<?php echo site_url('Member') ?>><i class="far fa-user"></i>
                                <span>Member</span></a></li>
                        <li><a class="nav-link" href=<?php echo site_url('Admfeedback') ?>><i class="far fa-user"></i>
                                <span>Feedback</span></a></li>
                        <li><a class="nav-link" href="blank.html"><i class="far fa-building"></i> <span>Toko</span></a>
                        </li>
                        <li class="nav-item dropdown">
                            <ul class="dropdown-menu">
