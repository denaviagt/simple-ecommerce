                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="form-group row">
                        <label for="editkota" class="col-sm-3 col-form-label">Nama Kota</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="editkota" name="namaKota" placeholder="Nama Kota" value="<?php echo $kota->namaKota; ?>">
                        </div>
                      </div>
                    </div>
