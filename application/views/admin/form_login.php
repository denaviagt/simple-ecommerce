...
<head>
  ...
  <link rel="stylesheet"href="<?php echo base_url('assets/admin/assets/css/componets.css'); ?>">
</head>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="POST" action="<?php echo base_url('index.php/login/aksi_login'); ?>" class="needs-validation" novalidate="">
