                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="form-group row">
                      <label for="editkategori" class="col-sm-3 col-form-label">Nama Kategori</label>
                      <div class="col-sm-9">
                      <input type="text" class="form-control" id="editkategori" name="namaKategori" placeholder="Nama Kategori" value="<?php echo $kategori->namakat;?>"> 
                    </div>
                  </div>
                </div>
