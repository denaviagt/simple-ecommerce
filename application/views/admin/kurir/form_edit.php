                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="form-group row">
                        <label for="editkurir" class="col-sm-3 col-form-label">Nama Kurir</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="editkurir" name="namaKurir" placeholder="Nama Kurir" value="<?php echo $kurir->namaKurir; ?>">
                        </div>
                      </div>
                    </div>
